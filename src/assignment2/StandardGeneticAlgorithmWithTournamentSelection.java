...
public class StandardGeneticAlgorithmWithTournamentSelection extends OptimizationAlgorithm {
     ...
     */
    public StandardGeneticAlgorithmWithTournamentSelection(int populationSize, int toMate, int toMutate, GeneticAlgorithmProblem gap) {
        super(gap);
        this.toMate = toMate;
    ...
    public double train() {
        ...
        for (int i = toMate; i < newPopulation.length; i++) {
            ...
            int k = dd.sample(null).getDiscrete();
